<template>
  <div
    class="point-popup-safe"
    v-if="isShow && safeInfo"
    ref="point-popup-safe"
    v-show="id"
  >
    <pointPopupTrafficTitle :areaInfo="safeInfo"></pointPopupTrafficTitle>
    <div class="content">
      <div :class="i.className" v-for="(i, _) in safeInfo.data">
        <!-- 顶部 -->
        <div class="top">
...
export default {
  ...
  mounted() {
    if ("point-popup-safe" == this.$route.name) {
      this.isShow = true;
